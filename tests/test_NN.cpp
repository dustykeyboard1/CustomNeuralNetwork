...
void testNeuralNetInitialization() {
    int samples = 10;        // Number of data samples
    int features = 5;        // Number of features per sample
    int hiddenSize = 16;     // Size of hidden layer
    int outputFeatures = 2;  // Output features

    NeuralNet nn;
    nn.initialize(samples, features, hiddenSize, outputFeatures);
