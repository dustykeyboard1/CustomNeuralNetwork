...
void testSigmoid()
{
    ...
    float A[6] = {-1, 2, -3, 4, -5, 6};
    float B[6] = {0};
    float expected[6] = {0.268941f, 0.880797f, 0.047426f,
                         0.982014f, 0.006693f, 0.997527f};  // Expected Sigmoid values
...
void testTanh()
{
    ...
    float B[6] = {0};
    float expected[6] = {-0.761594f, 0.000000f, 0.761594f, -0.964028f, 0.964028f, 0.995055f};
